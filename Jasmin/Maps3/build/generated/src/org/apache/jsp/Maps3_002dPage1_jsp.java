...
public final class Maps3_002dPage1_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                    content: '<div id = \"content\" contentEditable=\"true\">changeme...</div>' +\n");
      out.write("                            '<p>' + '<button onclick=\"saveToArray()\">Save</button>'\n");
      out.write("                });\n");
      out.write("\n");
      ...
      out.write("                    //infoWindowPolygon(polygon);\n");
      ...
      out.write("                });\n");
      out.write("\n");
      out.write("                google.maps.event.addListener(polygon, 'click', function () {\n");
      out.write("                    var vertices = polygon.getPath();\n");
      out.write("                    var bounds = new google.maps.LatLngBounds();\n");
      out.write("                    vertices.forEach(function (xy, i) {\n");
      out.write("                        bounds.extend(xy);\n");
      out.write("                    });\n");
      out.write("//                drawingManager.setDrawingMode(null);\n");
      out.write("                    infoWindow.setPosition(bounds.getCenter());\n");
      ...
      out.write("                window.location.assign(\"LoadSecondPageMaps3?polygons=\" + elementsJSON);\n");
      out.write("            }\n");
      out.write("\n");
      out.write("            function infoWindowPolygon(polygon) {\n");
      out.write("\n");
      out.write("            }\n");
      out.write("\n");
      out.write("            function saveToArray() {\n");
      out.write("                infoContent.push(document.getElementById(\"content\"));\n");
      out.write("                var contentsJSON = JSON.stringify(infoContent);\n");
      out.write("                alert(contentsJSON);\n");
      out.write("            }\n");
      out.write("\n");
      out.write("//            function createInfoWindow() {\n");
      out.write("//                google.maps.event.addListener(polygon, 'click', function () {\n");
      out.write("//                    var infoWindow1 = new google.maps.InfoWindow();\n");
      out.write("//                    infoWindow1.setContent(\"GUh\");\n");
      out.write("//                    infoWindow1.setPosition(bounds.getCenter());\n");
      out.write("//                })\n");
      out.write("//            }\n");
      out.write("\n");
      out.write("        </script>\n");
